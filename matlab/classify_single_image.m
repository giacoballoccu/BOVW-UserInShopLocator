...
if do_svm_inter_classification
    ...
    method_name='SVM IK';
    % Compute classification accuracy
    compute_accuracy(data_test,labels_test,precomp_ik_svm_lab,classes,method_name,desc_test,...
                      visualize_confmat & have_screen,... 
                      visualize_res & have_screen);
end
...
if do_svm_chi2_classification    
    ...
    % Compute classification accuracy
    compute_accuracy(data_test,labels_test,precomp_chi2_svm_lab,classes,method_name,desc_test,...
                      visualize_confmat & have_screen,... 
                      visualize_res & have_screen);
end
