...
dataset_dir_train ='/train_set/split_by_class_DEPTH';
dataset_dir_test = '/test_set/split_by_class_DEPTH';
...
% BOW PARAMETERS
%max_km_iters = 50; % maximum number of iterations for k-means -original
max_km_iters = 50;
%nfeat_codebook = 60000; % number of descriptors used by k-means for the codebook generation -original
...
if do_split_sets_train    
    ...
    load(fullfile(strcat(basepath, 'img/egocart'),'/train_set/split_by_class_DEPTH/', file_split));
end
...
if do_split_sets_test   
    ...
    load(fullfile(strcat(basepath, 'img/egocart'),'/test_set/split_by_class_DEPTH/',file_split));
end
...
if do_form_codebook
    ...
    for i=1:length(data_train)
        ...
        randimages = randperm(int16(data_train(i).n_images/100*40));
...
if do_L2_NN_classification
    ...
    compute_accuracy(data_test,labels_test,bof_l2lab,classes,method_name,desc_test,...
...
if do_chi2_NN_classification
    ...
    % Compute classification accuracy
    compute_accuracy(data_test,labels_test,bof_chi2lab,classes,method_name,desc_test,...
                      visualize_confmat & have_screen,... 
                      visualize_res & have_screen);
end
